...
public class InformationPortal  {
	...
	private final QuestionRepository questionRepository;
		...
		public void run(String... args) throws Exception {
			...
			answer.add(new Answer("contentasda ", lc, 7));
			answer.add(new Answer("asdadcontentasda ", lc, 7));
			answer.add(new Answer("contedsadadntasda ", lc, 7));
			answer.add(new Answer("contentaas   3t67mkl sda ", lc, 7));
			answer.add(new Answer("asdkazduasd75as78dz9pas0dhaspdäcontentasda ", lc, 7));
