...
export default new Vuex.Store({
  ...
  actions: {
    async act_getOneQuestion({ commit }, questionId) {
      ...
      await RestCalls.getOneQuestion(questionId).then((response) => {
        if (response != null) {
    ...
    async act_getAllQuestions({ commit }) {
      ...
      await RestCalls.getAllQuestions().then((response) => {
        if (response != null) {
    ...
    async act_getAllComments({ commit }, questionId) {
      ...
      await RestCalls.getAllCommentsToAnswers(questionId)
        .then((response) => {
          if (response != null) {
    ...
    async act_getAllTags({ commit }) {
      await RestCalls.getAllTags().then((response) => {
        if (response != null) {
    ...
    async act_creatNewQuestion({ commit }, newQuestion) {
      ...
      return await RestCalls.addNewQuestion(newQuestion).then((response) => {
        return response;
      }).catch((error) => {
        console.error(error);
      });
    ...
    async act_addNewAnswer({ commit }, newAnswer) {
      ...
      return await RestCalls.addNewAnswer(newAnswer).then((response) => {
        return response;
      }).catch((error) => {
        console.error(error);
      });
    ...
    async act_addNewComment({ commit }, newComment) {
      ...
      return await RestCalls.addNewComment(newComment).then((response) => {
        return response;
      }).catch((error) => {
        console.error(error);
      });
